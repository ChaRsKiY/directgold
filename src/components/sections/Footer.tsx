...
const footerLinks = {
  ...
  contactInfo: {
    title: 'Contact Info',
    links: [
      { label: 'Email: info@directgold.com', href: 'mailto:info@directgold.com' },
      { label: 'Phone: +1 234 567 890', href: 'tel:+1234567890' },
      { label: 'Address: Gold Street 123', href: '#address' },
    ],
  },
  importantLinks: {
      ...
      <Container className="py-12 md:py-16 lg:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold mb-4">{footerLinks.aboutUs.title}</h3>
          ...
          {/* Contact Info Column */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold mb-4">{footerLinks.contactInfo.title}</h3>
            <ul className="space-y-2">
              {footerLinks.contactInfo.links.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-sm text-gray-400 hover:text-gold transition-colors duration-300"
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold mb-4">{footerLinks.importantLinks.title}</h3>
            <ul className="space-y-2">
              {footerLinks.importantLinks.links.map((link) => (
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-sm text-gray-400 hover:text-gold transition-colors duration-300"
