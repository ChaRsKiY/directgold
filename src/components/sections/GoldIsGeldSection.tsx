        ...
        <div className="relative py-20 md:py-32 px-[5%] md:px-[10%] overflow-hidden min-h-[50vh] md:min-h-[80vh] flex items-center">
            <div className="relative z-10 flex justify-center max-w-4xl mx-auto w-full">
                <div className="flex flex-col relative w-fit mx-auto">
                    ...
                    <MotionH2
                        className="uppercase text-xl md:text-4xl lg:text-5xl font-bold text-center text-[var(--color-primary-text)] tracking-wide mb-6 max-md:mb-2 relative z-10 leading-tight"
                        initial={{ y: 30, opacity: 0 }}
                        whileInView={{ y: 0, opacity: 1 }}
                        viewport={{ once: true }}
                    ...
                    <MotionDiv
                        className="text-[var(--color-primary-text)] text-base md:text-lg font-medium self-end relative z-10 mt-2 md:mt-0"
                        initial={{ opacity: 0 }}
