...
const DominanzSection = () => {
    return (
        <section className="py-12 md:py-20 relative text-white px-[5%] md:px-[10%]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 m-auto max-w-7xl gap-8 md:gap-12">
                <div>
                    <MotionH2
                ...
                <div className="flex items-center justify-center">
                    <div className="w-full h-full relative before:absolute before:inset-0 before:bg-gradient-to-b before:from-[#5D9BC9] before:to-transparent before:opacity-40 before:-z-10 p-8 md:p-12 pb-16 md:pb-32 rounded-2xl md:rounded-none overflow-hidden md:overflow-visible">
