        ...
        <section className="py-12 md:py-20 relative text-white px-[5%] md:px-[10%]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 m-auto max-w-7xl gap-8 md:gap-12 min-h-[60vh] max-h-[850px]">
                ...
                <div className="flex items-center justify-center gap-16 max-md:gap-4">
                    <div className="w-full h-full relative before:absolute before:inset-0 before:bg-gradient-to-b before:from-blue-light before:to-transparent before:opacity-40 before:-z-10 p-8 md:p-12 pb-16 md:pb-32 overflow-hidden md:overflow-visible">
                    ...
                    <div className="w-1 h-full bg-gold rounded-full" />
                </div>
            </div>
        </section>
    );
