  ...
  return (
    <section className="flex w-full flex-col items-center gap-8 px-6 pb-24 text-center md:gap-10 md:pb-32">
      <div className="space-y-4">
        <h2 className="text-balance text-[clamp(2.1rem,5vw,3rem)] font-semibold leading-tight text-banner-title">
          {title}
        </h2>
        {subtitle ? (
          <p className="text-base uppercase tracking-[0.4rem] text-banner-subtitle">
            {subtitle}
          </p>
        ) : null}
      </div>
